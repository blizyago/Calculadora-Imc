...
class _HomeState extends State<Home> {
  ...
  final resultados =[
    Resultado("assets/img/imgAbeso/imc_m_06.png", "assets/img/imgAbeso/imc_06.png",
        "18,5 ou menos",
        "Abaixo do Normal",
    ...
    Resultado("assets/img/imgAbeso/imc_m_05.png", "assets/img/imgAbeso/imc_05.png",
        "Entre 18.6 e 24.9",
        "Normal",
    ...
    Resultado("assets/img/imgAbeso/imc_m_04.png", "assets/img/imgAbeso/imc_04.png",
        "Entre 25,0 e 29,9",
        "Sobrepeso",
    ...
    Resultado("assets/img/imgAbeso/imc_m_03.png", "assets/img/imgAbeso/imc_03.png",
        "Entre 30,0 e 34,9",
        "Obesidade Grau I",
    ...
    Resultado("assets/img/imgAbeso/imc_m_02.png", "assets/img/imgAbeso/imc_02.png",
        "Entre 35,0 e 39,9",
        "Obesidade Grau II",
    ...
    Resultado("assets/img/imgAbeso/imc_m_01.png", "assets/img/imgAbeso/imc_01.png",
        "Acima de 40,0",
        "Obesidade Grau III",
        ...
        child: SingleChildScrollView(
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: <Widget> [
                  Image.asset(
                    "assets/img/sal.png",height: 240,width: 240,
                  ),
